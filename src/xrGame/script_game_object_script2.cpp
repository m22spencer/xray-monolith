...
class_<CScriptGameObject> script_register_game_object1(class_<CScriptGameObject> &&instance)
{
	return std::move(instance)
		...
		.property("psy_health", SAFE_WRAP(&CScriptGameObject::GetPsyHealth), SAFE_WRAP(&CScriptGameObject::SetPsyHealth))
		.property("power", SAFE_WRAP(&CScriptGameObject::GetPower), SAFE_WRAP(&CScriptGameObject::SetPower))
		.property("satiety", SAFE_WRAP(&CScriptGameObject::GetSatiety), SAFE_WRAP(&CScriptGameObject::SetSatiety))
		.property("radiation", SAFE_WRAP(&CScriptGameObject::GetRadiation), SAFE_WRAP(&CScriptGameObject::SetRadiation))
		.property("morale", SAFE_WRAP(&CScriptGameObject::GetMorale), SAFE_WRAP(&CScriptGameObject::SetMorale))

		.property("bleeding", SAFE_WRAP(&CScriptGameObject::GetBleeding), SAFE_WRAP(&CScriptGameObject::ChangeBleeding))

		.def("change_health", SAFE_WRAP(&CScriptGameObject::ChangeHealth))
		.def("change_psy_health", SAFE_WRAP(&CScriptGameObject::ChangePsyHealth))
		.def("change_power", SAFE_WRAP(&CScriptGameObject::ChangePower))
		.def("change_satiety", SAFE_WRAP(&CScriptGameObject::ChangeSatiety))
		.def("change_radiation", SAFE_WRAP(&CScriptGameObject::ChangeRadiation))
		.def("change_morale", SAFE_WRAP(&CScriptGameObject::ChangeMorale))
		...
		.def("mass", SAFE_WRAP(&CScriptGameObject::Mass))
		...
		.def("death_time", SAFE_WRAP(&CScriptGameObject::DeathTime))
		//		.def("armor",						&CScriptGameObject::Armor)
		.def("max_health", SAFE_WRAP(&CScriptGameObject::MaxHealth))
		.def("accuracy", SAFE_WRAP(&CScriptGameObject::Accuracy))
		.def("alive", SAFE_WRAP(&CScriptGameObject::Alive))
		.def("team", SAFE_WRAP(&CScriptGameObject::Team))
		.def("squad", SAFE_WRAP(&CScriptGameObject::Squad))
		.def("group", SAFE_WRAP(&CScriptGameObject::Group))
		...
		.def("fov", SAFE_WRAP(&CScriptGameObject::GetFOV))
		.def("range", SAFE_WRAP(&CScriptGameObject::GetRange))
		...
		.def("get_script_name", SAFE_WRAP(&CScriptGameObject::GetScriptControlName))
		...
		.def("action_count", SAFE_WRAP(&CScriptGameObject::GetActionCount))
		...
		.def("get_enemy_strength", SAFE_WRAP(&CScriptGameObject::GetEnemyStrength))
		...
		.def("can_script_capture", SAFE_WRAP(&CScriptGameObject::can_script_capture))
